...
public class Ghost3T implements Runnable {
    ...
    public static boolean volver3 = false;

    public Ghost3T(ComecocosFrameTeleco fr, int nivel) {
        frame = fr;
    ...
    public void run() {
        try {
            while (continuar) {
                ...
                Thread.sleep(delay);
                if ((frame.getRejilla().getTipoCelda(16, 23) == frame.getRejilla().nada) && (!Figura_ghost3T.isComestible()) && subir) {
                    frame.getFig_ghost3().mueve(Figura_ghost3T.ARRIBA);
                } else {
                    subir = false;
                    if ((!Figura_ghost3T.isComestible()) && (volver3 == false)) {
                        ...
                        direccion_anterior = Figura_ghost3T.direccion;
                        k = 0;
                        if ((!frame.getRejilla().seChocaFantasma3(frame.getFig_ghost3(), Figura_ghost3T.IZQUIERDA)) && (direccion_anterior != Figura_ghost3T.DERECHA)) {
                            ...
                            direcciones[k] = Figura_ghost3T.IZQUIERDA;
                            posibles[0] = true;
                        }
                        k = 1;

                        if ((!frame.getRejilla().seChocaFantasma3(frame.getFig_ghost3(), Figura_ghost3T.DERECHA)) && (direccion_anterior != Figura_ghost3T.IZQUIERDA)) {
                            dist[k] = frame.distancia(frame.getFigura().getXOrigen(), frame.getFig_ghost3().getXOrigen() + 1, frame.getFigura().getYOrigen(), frame.getFig_ghost3().getYOrigen());
                            direcciones[k] = Figura_ghost3T.DERECHA;
                            posibles[1] = true;
                        }
                        k = 2;
                        if ((!frame.getRejilla().seChocaFantasma3(frame.getFig_ghost3(), Figura_ghost3T.ARRIBA)) && (direccion_anterior != Figura_ghost3T.ABAJO)) {
                            ...
                            direcciones[k] = Figura_ghost3T.ARRIBA;
                            posibles[2] = true;
                        }
                        k = 3;
                        if ((!frame.getRejilla().seChocaFantasma3(frame.getFig_ghost3(), Figura_ghost3T.ABAJO)) && (direccion_anterior != Figura_ghost3T.ARRIBA)) {
                            dist[k] = frame.distancia(frame.getFigura().getXOrigen(), frame.getFig_ghost3().getXOrigen(), frame.getFigura().getYOrigen(), frame.getFig_ghost3().getYOrigen() + 1);
                            direcciones[k] = Figura_ghost3T.ABAJO;
                            posibles[3] = true;
                        ...
                        if (num_posibilidades == 1) {
                            Figura_ghost3T.direccion = direcciones[var];
                            frame.getFig_ghost3().mueve(Figura_ghost3T.direccion);
                            direccion_anterior = direcciones[var];
                        } else {
                            double prob = Math.random();
                            if ((prob <= 0.5)) {
                                Figura_ghost3T.direccion = direcciones[0];
                                frame.getFig_ghost3().mueve(Figura_ghost3T.direccion);
                                direccion_anterior = direcciones[0];
                            } else if (prob > 0.5) {
                                Figura_ghost3T.direccion = direcciones[1];
                                frame.getFig_ghost3().mueve(Figura_ghost3T.direccion);
                        ...
                        if (volver3 == true) {
                            if ((Figura_ghost3T.xorigen == 24) && (Figura_ghost3T.yorigen == 17)) {
                                volver3 = false;
                                subir = false;
                            ...
                            k = 0;
                            if ((!frame.getRejilla().seChocaFantasma3(frame.getFig_ghost3(), Figura_ghost3T.IZQUIERDA)) && (direccion_anterior != Figura_ghost3T.DERECHA)) {
                                dist[k] = frame.distancia(24, frame.getFig_ghost3().getXOrigen() - 1, 17, frame.getFig_ghost3().getYOrigen());
                                direcciones[k] = Figura_ghost3T.IZQUIERDA;
                                posibles[0] = true;
                            }
                            k = 1;
                            ...
                            k = 2;
                            if ((!frame.getRejilla().seChocaFantasma3(frame.getFig_ghost3(), Figura_ghost3T.ARRIBA)) && (direccion_anterior != Figura_ghost3T.ABAJO)) {
                                dist[k] = frame.distancia(24, frame.getFig_ghost3().getXOrigen(), 17, frame.getFig_ghost3().getYOrigen() - 1);
                                direcciones[k] = Figura_ghost3T.ARRIBA;
                                posibles[2] = true;
                            }
                            k = 3;
