...
public class Figura_ghost3T {
    ...
    public Figura_ghost3T(int entero) {
        elemento = entero;
    }

    public static Figura_ghost3T nuevoFantasma() {
        Figura_ghost3T fan = new Figura_ghost3T(0);
        direccion = 0;
        fan.xorigen = 24;
        fan.yorigen = 17;
    ...
    public static void setXorigen(int xorigen) {
        Figura_ghost3T.xorigen = xorigen;
    }
    ...
    public static void setYorigen(int yorigen) {
        Figura_ghost3T.yorigen = yorigen;
    }
    ...
    public static void setComestible(boolean comestible) {
        Figura_ghost3T.comestible = comestible;
    }
