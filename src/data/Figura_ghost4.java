...
/**
 * La clase Figura_ghost4 es la encargada representar al fantasma 4.
 *
 * @author Ignacio y Alejandro
 */
import java.util.Vector;

public class Figura_ghost4 {
     ...
     */
    public Figura_ghost4() {

    }

    /**
     * Método que crea una un fantasma llamando al constructor por defecto de la
     * clase. La posición inicial del cuarto fantasma dentro del tablero la
     * fijamos a x=14, y=13.
     *
     *
     * @return fan
     */
    public static Figura_ghost4 nuevoFantasma() {
        Figura_ghost4 fan = new Figura_ghost4();
        direccion = 0;
        fan.xorigen = 14;
        fan.yorigen = 13;
    ...
    public static void setComestible(boolean comestible) {
        Figura_ghost4.comestible = comestible;
    }
