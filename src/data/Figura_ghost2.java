...
/**
 * La clase Figura_ghost2 es la encargada representar al fantasma 2.
 *
 * @author Ignacio y Alejandro
 */
import java.util.Vector;

public class Figura_ghost2 {
     ...
     */
    public Figura_ghost2() {
    }

    /**
     * Método que crea una un fantasma llamando al constructor por defecto de la
     * clase. La posición inicial del segundo fantasma dentro del tablero la
     * fijamos a x=12, y=13.
     *
     *
     * @return fan
     */
    public static Figura_ghost2 nuevoFantasma() {
        Figura_ghost2 fan = new Figura_ghost2();
        direccion = 0;
        fan.xorigen = 12;
        fan.yorigen = 13;
    ...
    public static void setComestible(boolean comestible) {
        Figura_ghost2.comestible = comestible;
    }
